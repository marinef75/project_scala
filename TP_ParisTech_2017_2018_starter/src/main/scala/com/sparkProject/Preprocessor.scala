...
object Preprocessor {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = spark
      ...
      .csv("/Users/marine/Documents/Telecom/spark/TP_ParisTech_2017_2018_starter/data/train.csv")
    ...
    dfFiltered.write.mode(SaveMode.Overwrite).parquet("/Users/marine/Documents/Telecom/spark/TP_parisTech_2017_2018/data/prepared_trainingset")
